...
export class SkillsManager {
     ...
     */
    async readForAgent(agentId, skillId) {
     ...
     */
    async installForAgent(agentId, skillId, options) {
     ...
     */
    async uninstallForAgent(agentId, skillId) {
    ...
    async installToDir(baseDir, id, options) {
        const skillPath = join(baseDir, id);
